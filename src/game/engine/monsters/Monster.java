...
public abstract class Monster implements Comparable<Monster> {
	...
	public void setConfusionTurns(int confusionTurns) { this.confusionTurns = Math.max(0, confusionTurns); }
